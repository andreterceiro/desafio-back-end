Esté é um desafio que devo permitir o logon (usuário: andre, senha: teste) e, após logado, devo aceitar o upload de 1 arquivo.

É uma aplicação Rails, seguindo o padrão.
